	...
	return (
		<div className="h-80 flex flex-col justify-center">
			<div className="flex justify-between">
				...
				<TextScroller href="/policy" items={[<span key="policy-primary">POLICY</span>, <span key="policy-hover">POLICY</span>]} interaction="hover" className="text-base tracking-tighter uppercase h-8 font-standard mr-34" textAlign="center" />
