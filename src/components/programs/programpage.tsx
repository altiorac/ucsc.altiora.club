...
export default function ProgramPage({ title, description, content, next, image }: { title: string; description: string; content: string; next: string; image: StaticImageData }) {
    ...
    return (
        <div>
            ...
            <div className="w-screen h-screen flex flex-col justify-center text-center items-center">
                <CursorBadge>
                    <Link href={`/programs/${nextProjectSlug}`}>
